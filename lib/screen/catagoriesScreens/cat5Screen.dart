...
class Cat5Bulk extends StatefulWidget {
  @override
  _Cat5BulkState createState() => _Cat5BulkState();
}

class _Cat5BulkState extends State<Cat5Bulk> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Cat5 Bulk Cables"),
        centerTitle: true,
        backgroundColor: appBarColor,
      ),
       body: FutureBuilder(
        future:
            ScopedModel.of<MainModel>(context).fetchCategories(),
        builder: (_, snapshot) {
