...
class Cat6Bulk extends StatefulWidget {
  @override
  _Cat6BulkState createState() => _Cat6BulkState();
}

class _Cat6BulkState extends State<Cat6Bulk> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Cat6 Bulk Cables"),
      ),
      body: FutureBuilder(
        future:
            ScopedModel.of<MainModel>(context).fetchCat6(),
        builder: (_, snapshot) {
